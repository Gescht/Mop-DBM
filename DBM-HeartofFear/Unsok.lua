...
mod:SetRevision(("$Revision: 11260 $"):sub(12, -3))
...
mod:RegisterEventsInCombat(
	...
	"SPELL_CAST_SUCCESS 122348 121994 122532 123156 122389 122413",
	"SPELL_DAMAGE 122504",
	"SPELL_MISSED 122504",
...
local timerFlingCD				= mod:NewCDTimer(25, 122413, nil)--25-40sec variation.
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif spellId == 122540 then  -- p2 start
		Phase = 2
...
function mod:SPELL_CAST_START(args)
	...
	elseif spellId == 122413 and self:AntiSpam(2, 1) then --122457 debuff id
